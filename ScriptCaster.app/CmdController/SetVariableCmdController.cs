...
namespace ScriptCaster.App.CmdController
{
    ...
    */
    public static class SetVariableCmdController
    {
        ...
        private static string CurrentTargetStr => _currentTarget == VariableFile.Global ? "global variable file" : "template variable file";
        ...
        private static string[] OptionsDisplay()
        {
            var command = AnsiConsole.Prompt(
                new SelectionPrompt<string>()
                    ...
                    .AddChoices(new[] {
                        "[cyan]list variables[/]", 
                        "[cyan]add a new variable to the buffer[/]", 
                        "[cyan]remove a variable from the buffer[/]", 
                        "[cyan]edit a variable in the buffer[/]", 
                        "[cyan]write the changes in the buffer[/]", 
                        "[cyan]change the variable target[/]", 
                        "[cyan]quit [/]",
                    }));
